...
SHOT_B_SOURCE=PROVEN
SHOT_B_PLACEMENT=PASS
SHOT_B_SHA_MATCH=True
SHOT_B_SHA256=c6acf2afec4c29f1e55aba23e5418f8f2dc86b6cece669728c73c96170dd8254
SHOT_B_ONE_TO_ONE=True
SHOT_B_MIN_RESOLUTION_PASS=True
SHOT_C=NOT_PLACED
SHOT_D=NOT_PLACED
SHOT_E=NOT_PLACED
...
```text
BOTTLENECK=SHOT_C_TO_E_NOT_PLACED
CAUSE=SHOT_A・SHOT_Bは固定済みだが、30秒masterに必要なSHOT_C・D・Eの3画像が未固定
UNBLOCK=SHOT_C→D→Eを1:1 PNGで生成・SHA固定
NEXT=BUILD_SHOT_C_1603
