...
rules = [
    ...
    (r'cwebp|dwebp|vwebp|webpmux|magick|mogrify|convert|montage|identify|exr|tiff|jpeg|png', "image"),
    (r'curl|httpie|http[^s]*$|wget|nmap|(^|/)nc$|ncat|nping|ngrok|cloudflared|kubectl|helm|minikube|kind', "network"),
...
with open(out, "w", newline="", encoding="utf-8") as f:
    w = csv.DictWriter(f, fieldnames=["name","category","path"]); w.writeheader(); w.writerows(rows)
